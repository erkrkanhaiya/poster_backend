...
apiV1Router.use('/admin/subcategories', require('./admin/subcategory.routes'));
apiV1Router.use('/admin/saved-categories', require('./admin/savedCategories.routes'));
...
apiV1Router.use('/users/subcategories', require('./users/subcategory.routes'));
apiV1Router.use('/users/saved-categories', require('./users/savedCategories.routes'));
